...
2. Add application → **DGator86/Milestone-Life**
3. **Team settings → Integrations → Apple Developer Portal** (API key from App Store Connect)
4. **Team settings → Integrations → App Store Connect**
5. Start workflow **Milestone Life iOS** (uses `codemagic.yaml`)
